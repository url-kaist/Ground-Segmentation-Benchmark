...
import pypcd
labelname = "/media/shapelim/UX960 NVMe/kitti_semantic/dataset/sequences/00/labels/000000.label"
labels = np.fromfile(labelname, dtype=np.uint32)
print(labels.shape)
pc = np.fromfile("/media/shapelim/UX960 NVMe/kitti_semantic/dataset/sequences/00/velodyne/000000.bin", dtype=np.float32).reshape(-1, 4)
