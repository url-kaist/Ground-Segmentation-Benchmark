...
def main():
    ...
    ABS_PATH = "/home/shapelim/hdd2/kitti_semantic/dataset"
    ...
    parser.add_argument("--savedir", default=ABS_PATH, help="base directory of the dataset, if no directory passed the deafult is current working directory")
    ...
    if args.kitti_type.find("raw") != -1:
        ...
        bag = rosbag.Bag(os.path.join(args.savedir, "kitti_data_odometry_{}_sequence_{}.bag".format(args.kitti_type[5:],args.sequence)), 'w', compression=compression)
        ...
        try:
            ...
            if args.kitti_type.find("gray") != -1:
                ...
                used_cameras = cameras[-2:]
	    if args.kitti_type.find("noimg") < 0:
